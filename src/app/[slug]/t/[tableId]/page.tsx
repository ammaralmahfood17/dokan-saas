              ...
              {items.map((ci) => (
                <div key={ci.cartId} className="flex gap-3">
                  <div className="flex-1 min-w-0">
                    ...
                    {ci.notes && (
                      <div className="text-xs text-warning italic">{'\u201C'}{ci.notes}{'\u201D'}</div>
                    )}
      ...
      <div className="bg-card border border-border rounded-2xl p-6 w-full max-w-sm
        ...
        <button
          ...
          className="absolute top-3 end-3 w-8 h-8 flex items-center justify-center
                     rounded-full bg-secondary active:bg-secondary text-muted-foreground
        ...
        <div className="text-center mb-6">
          ...
          <div className="ticket-number text-3xl text-primary mt-1">{orderNumber}</div>
        ...
        {!['completed', 'cancelled'].includes(status) && (
          <button
            ...
            className="w-full min-h-[44px] py-2.5 rounded-xl text-sm font-medium
                       ...
                       bg-secondary text-foreground active:bg-secondary"
          >
            📋 رجوع للمنيو
          </button>
        )}
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mt-1 flex-wrap">
                <span className={cn(
                  ...
                  reallyOpen ? 'bg-success/15 text-success' : 'bg-destructive/15 text-destructive'
                )}>
              ...
              <button
                ...
                className={cn(
                  ...
                  selectedCategory === cat.id
                    ...
                    : 'border-border text-muted-foreground active:border-secondary-foreground/20'
                )}
              >
...
function ItemCard({
  ...
  return (
    <button
      onClick={onClick}
      className="card-hover flex items-center gap-3 text-start w-full py-3 active:bg-secondary"
    >
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          ...
          {item.is_featured && <Star size={12} className="text-warning flex-shrink-0" />}
        </div>
        {item.description_ar && (
