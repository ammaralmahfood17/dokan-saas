                  ...
                  {items.map(ci => (
                    <div key={ci.cartId} className="flex gap-3">
                      <div className="flex-1 min-w-0">
                        ...
                        {ci.notes && <div className="text-xs text-warning italic">{'\\u201C'}{ci.notes}{'\\u201D'}</div>}
                      ...
                      <div className="flex items-center gap-1 flex-shrink-0">
                        ...
                        <button onClick={() => removeItem(ci.cartId)} className="w-10 h-10 flex items-center justify-center text-destructive active:text-destructive active:bg-destructive/10 rounded-lg transition-colors touch-manipulation"><X size={15} /></button>
                      </div>
                    </div>
                  ))}
              <div>
