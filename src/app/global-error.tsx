  ...
  return (
    <html lang="ar" dir="rtl">
      <head>
        ...
        <style>{`
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          p { color: hsl(var(--muted-foreground)); margin: 0 0 1.5rem; line-height: 1.6; font-size: 0.9rem; }
          ...
          .primary { background: #C2540C; color: #FEFCF9; }
          .primary:hover { background: #A3450A; }
          .secondary { background: transparent; color: hsl(var(--muted-foreground)); border-color: hsl(var(--border)); }
          .secondary:hover { color: hsl(var(--foreground)); border-color: hsl(var(--border)); }
      ...
      <body>
        <div className="card">
          <div className="icon">
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="hsl(var(--destructive))" strokeWidth="1.5"
